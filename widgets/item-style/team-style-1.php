<!--  fadeIn Start Here -->
<div id="hover_area">
  <figure class="mc-item mc-item--fadeIn extrafadeIn">
    <img src="<?php echo esc_url($settings['stylistteam_image']['url'], 'teamcard');?>" alt="<?php the_title_attribute( );?>" class="mc-item__image">
