<!-- slideInDownBig zoomOut Area Start Here -->
<div id="hover_area">
  <figure class="mc-item mc-item--slideInDownBig-zoomOut extraslideInDownBigzoomOutt">
...
<!-- slideInDownBig zoomOut Area End Here -->