<!-- slideInLeftBig zoomOut Area Start Here -->
<div id="hover_area">
  <figure class="mc-item mc-item--slideInLeftBig-zoomOut extraslideInLeftBigzoomOut">
...
<!-- slideInLeftBig zoomOut Area End Here -->